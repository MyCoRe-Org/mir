    ...
    <form>
        <div class="mir-form-group">
            <div class="input-group input-group-sm mb-3">
                <input v-model="model.inputValue" :disabled="searchEnabled?null:''" :aria-label="i18n['mir.editor.subject.search.placeholder']" @submit.prevent type="text" :placeholder="i18n['mir.editor.subject.search.placeholder']" class="form-control search-topic">
