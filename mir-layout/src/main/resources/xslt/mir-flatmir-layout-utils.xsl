      ...
      <div class="row">
        ...
        <div class="col-2">
          ...
          <ul class="social_links">
            <li><a href="#"><button type="button" aria-label="Facebook" class="social_icons social_icon_fb"></button>Facebook</a></li>
            <li><a href="#"><button type="button" aria-label="X" class="social_icons social_icon_x"></button>X</a></li>
          </ul>
        </div>
        <div class="col-2">
