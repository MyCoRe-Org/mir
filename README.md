...
| DEVELOPER_MODE                 | false               | If `true`,  confguration properties to enable the [developer mode](https://www.mycore.de/documentation/developer/dev_devmode/) will be added, the folder configured by `MIR_OVERRIDE` will be mounted as a override folder and the developer commands will be enabled.                            |
