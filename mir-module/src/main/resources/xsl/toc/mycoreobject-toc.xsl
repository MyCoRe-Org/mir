...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    ...
    <xsl:variable name="tocLayouts" select="document('xslStyleXEditor:toc/toc-layouts2solr-json-facet-query:resource:toc-layouts.xml')/*" />
    ...
    <xsl:variable name="prepURI">
      <xsl:text>xslStyleXEditor:toc/solr-facets2toc</xsl:text>
    ...
    <xsl:variable name="htmlURI">
      <xsl:text>notnull:xslStyleXEditor:toc/render-toc:</xsl:text>
