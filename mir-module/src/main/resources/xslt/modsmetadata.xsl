...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template name="printMetaDate.mods">
    ...
    <xsl:param name="label" select="mcri18n:translate(concat('component.mods.metaData.dictionary.',local-name($nodes[1])))" />
  ...
  <xsl:template match="mods:dateCreated|mods:dateOther|mods:dateIssued|mods:dateCaptured|mods:dateModified" mode="present">
    <xsl:param name="label">
      <xsl:choose>
        <xsl:when test="(@point='start' or @point='end') and mcri18n:exists(concat('component.mods.metaData.dictionary.',local-name(), '.range'))">
          <xsl:value-of select="mcri18n:translate(concat('component.mods.metaData.dictionary.',local-name(), '.range'))"/>
        </xsl:when>
        <xsl:otherwise>
          <xsl:value-of select="mcri18n:translate(concat('component.mods.metaData.dictionary.',local-name()))"/>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:param>
  ...
  <xsl:template match="mods:titleInfo" mode="present">
    <xsl:if test="not(@transliteration='text/html')">
          ...
          <td valign="top" class="metaname">
            <xsl:choose>
              <xsl:when test="./../@type='translated'">
                <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.title'),' (',./../@xml:lang,'):')" />
              </xsl:when>
              <xsl:when test="./../@type='alternative' and ./../@displayLabel='Short form of the title'">
                <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.shorttitle'),':')" />
              </xsl:when>
              <xsl:otherwise>
                <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.title'),':')" />
              </xsl:otherwise>
            </xsl:choose>
          </td>
      ...
      <xsl:if test="mods:subTitle">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.subtitle'),':')" />
          </td>
          ...
          <table class="metaData">
              ...
              <tr>
                <td valign="top" class="metaname">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.name'),':')" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                <td class="metavalue">
            ...
            <xsl:if test="./structure/children/child">
              <xsl:apply-templates mode="printChildren" select="./structure/children">
                <xsl:with-param name="label" select="mcri18n:translate('component.mods.metaData.dictionary.contains')" />
              </xsl:apply-templates>
            </xsl:if>
          </table>
        </div>
  ...
  <xsl:template name="printMetaDate.mods.abstractContent">
    <div id="abstract_box" class="detailbox">
      <h4 id="abstract_switch" class="block_switch">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.abstractbox')" />
      </h4>
  ...
  <xsl:template match="mods:extent" mode="present">
    <tr>
      <td valign="top" class="metaname">
        <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.extent'),':')" />
      </td>
      <td class="metavalue">
  ...
  <xsl:template match="mods:extension[@displayLabel='characteristics']" mode="present">
    <xsl:if test="not(mcracl:is-current-user-in-role('guest'))">
      <tr>
        <td valign="top" class="metaname">
          <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.characteristics'),':')" />
        </td>
        <td class="metavalue">
              ...
              <tr>
                ...
                <td>
                  <xsl:if test="@refereed">
                    <xsl:value-of select="mcri18n:translate(concat('component.mods.metaData.dictionary.refereed.',@refereed))" />
                  </xsl:if>
                </td>
              </tr>
            </xsl:for-each>
  ...
  <xsl:template match="mods:extension" mode="present">
    <tr>
      <td valign="top" class="metaname">
        <xsl:value-of select="concat(mcri18n:translate(concat('component.mods.metaData.dictionary.',@displayLabel)),':')" />
      </td>
      <td class="metavalue">
        <xsl:value-of select="." />
      </td>
  ...
  <xsl:template match="mods:name[@type='corporate' and @ID]" mode="present">
    ...
    <tr>
      <td valign="top" class="metaname">
        <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.institution.label'),':')" />
      </td>
      <td class="metavalue">
        <xsl:apply-templates select="." mode="printName" />
      </td>
    ...
    <xsl:if
      test="(not(mcracl:is-current-user-in-role('guest')) and ./../mods:note[@xlink:href=$id]) or (./../mods:location/mods:physicalLocation[@xlink:href=$id])">
      <tr>
        <td colspan="2">
          <table class="metaData">
            <xsl:if test="not(mcracl:is-current-user-in-role('guest'))">
      ...
      <td valign="top" class="metaname">
        <xsl:choose>
          <xsl:when test="mods:role/mods:roleTerm[@type='code' and @authority='marcrelator']">
            <xsl:value-of select="concat(mcri18n:translate(concat('component.mods.metaData.dictionary.institution.', mods:role/mods:roleTerm[@type='code' and @authority='marcrelator'], '.label')),':')" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.institution.label'),':')" />
          </xsl:otherwise>
  ...
  <xsl:template match="mods:identifier[@type='hdl']" mode="present">
    <tr>
      <td valign="top" class="metaname">
        <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.identifier.hdl'),':')" />
      </td>
      <td class="metavalue">
    ...
    <tr>
      ...
      <xsl:choose>
        <xsl:when test="not($identifier//category[@ID=$type])">
            <xsl:value-of select="concat(mcri18n:translate-with-params('component.mods.metaData.dictionary.identifier.other', $type), ':')" />
          </xsl:when>
          <xsl:otherwise>
  ...
  <xsl:template match="mods:identifier[@type='intern_old']" mode="present">
    <xsl:if test="not(mcracl:is-current-user-in-role('guest'))">
      <tr>
        <td valign="top" class="metaname">
          <xsl:value-of select="concat(mcri18n:translate(concat('component.mods.metaData.dictionary.identifier.',@type)),':')" />
        </td>
        <td class="metavalue">
          <xsl:value-of select="." />
        </td>
      ...
      <td valign="top" class="metaname">
        <xsl:choose>
          <xsl:when test="contains(.,'ppn') or contains(.,'PPN')">
            <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.identifier.ppn'),':')" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:value-of select="concat(mcri18n:translate(concat('component.mods.metaData.dictionary.identifier.',@type)),':')" />
          </xsl:otherwise>
  ...
  <xsl:template match="mods:identifier[@type='scopus']" mode="present">
    <tr>
      <td valign="top" class="metaname">
        <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.identifier.scopus'),':')" />
      </td>
      <td class="metavalue">
      ...
      <td valign="top" class="metaname">
        <xsl:choose>
          <xsl:when test="@authority='sdnb'">
            <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.sdnb'), ':')" />
          </xsl:when>
          <xsl:when test="@displayLabel='status'">
            <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.status'), ':')" />
          </xsl:when>
          <xsl:when test="not(contains(mcri18n:translate(concat('component.mods.metaData.dictionary.', @displayLabel)), 'component.mods.metaData.dictionary.'))">
            <xsl:value-of select="concat(mcri18n:translate(concat('component.mods.metaData.dictionary.', @displayLabel)), ':')" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.classification'), ':')" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td class="metavalue">
  ...
  <xsl:template match="mods:language" mode="present">
    ...
    <tr>
      <td valign="top" class="metaname">
        <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.language'), ':')" />
      </td>
      <td class="metavalue">
  ...
  <xsl:template name="printMetaDate.mods.permalink">
    <tr>
      <td valign="top" class="metaname">
        <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.permalink'),':')" />
      </td>
      <td class="metavalue">
...
<!--         <xsl:text> | </xsl:text>
    ...
    <xsl:if
      ...
      <div id="category_box" class="detailbox">
        <h4 id="category_switch" class="block_switch open">
          <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.categorybox')" />
        </h4>
        <div id="category_content" class="block_content">
          <table class="metaData">
            <xsl:if test="./metadata/def.modsContainer/modsContainer/mods:mods/mods:genre[@type='kindof']">
              <tr>
                <td valign="top" class="metaname">
                  <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.genre.kindof'),':')" />
                </td>
                <td class="metavalue">
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.modsDefaultType">
    ...
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate(concat('component.mods.metaData.dictionary.', $mods-type))" />
      </h4>
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.report">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.report')" />
      </h4>
      <xsl:call-template name="printMetaDate.mods.titleContent" />
    </div>
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.thesis">
    <div id="title_box" class="detailbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.thesis'), ' - ')" />
        <xsl:apply-templates select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:genre[@type='kindof']"
          mode="printModsClassInfo" />
      </h4>
      <xsl:call-template name="printMetaDate.mods.titleContent" />
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.confpro">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.confpro')" />
      </h4>
      <div id="title_content" class="block_content">
        <div class="subcolumns">
          <div class="c85l">
            <table class="metaData">
              <xsl:for-each select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:name[@type='conference']">
                <tr>
                  <td valign="top" class="metaname">
                    <xsl:value-of select="concat(mcri18n:translate('component.mods.metaData.dictionary.conference.title'),':')" />
                  </td>
                  <td class="metavalue">
                    <strong>
              ...
              <xsl:if test="not(./metadata/def.modsContainer/modsContainer/mods:mods/mods:titleInfo)">
                <tr>
                  ...
                  <td class="metavalue">
                    <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.conference.notReleased')" />
                  </td>
                </tr>
              </xsl:if>
              <xsl:apply-templates mode="present" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:titleInfo" />
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.confpub">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.confpub')" />
      </h4>
      <xsl:call-template name="printMetaDate.mods.titleContent" />
    </div>
        ...
        <div id="category_content" class="block_content">
          <table class="metaData">
            ...
            <xsl:call-template name="printMetaDate.mods">
              ...
              <xsl:with-param name="label" select="mcri18n:translate('component.mods.metaData.dictionary.authority')" />
            </xsl:call-template>
            <xsl:call-template name="printMetaDate.mods">
              <xsl:with-param name="nodes" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:subject" />
              <xsl:with-param name="sep" select="'; '" />
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.book">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.book')" />
      </h4>
      <xsl:call-template name="printMetaDate.mods.titleContent" />
    </div>
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.chapter">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.chapter')" />
      </h4>
      <xsl:call-template name="printMetaDate.mods.titleContent" />
    </div>
        ...
        <div id="category_content" class="block_content">
          <table class="metaData">
            <xsl:if test="./structure/parents/parent/@xlink:href or ./metadata/def.modsContainer/modsContainer/mods:mods/mods:relatedItem[@type='host']">
              <xsl:call-template name="printMetaDate.mods.relatedItem">
                <xsl:with-param name="parentID" select="./structure/parents/parent/@xlink:href" />
                <xsl:with-param name="label" select="mcri18n:translate('component.mods.metaData.dictionary.chapterIn')" />
              </xsl:call-template>
            </xsl:if>
            <xsl:apply-templates mode="present" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:identifier" />
            <xsl:call-template name="printMetaDate.mods.permalink" />
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.journal">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.journal')" />
      </h4>
      <div id="title_content" class="block_content">
        <table class="metaData">
          <xsl:apply-templates mode="present" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:titleInfo" />
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.series">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.series')" />
      </h4>
      <div id="title_content" class="block_content">
        <table class="metaData">
          <xsl:apply-templates mode="present" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:titleInfo" />
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.article">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.article')" />
      </h4>
      <xsl:call-template name="printMetaDate.mods.titleContent" />
    </div>
        ...
        <div id="category_content" class="block_content">
          ...
          <table class="metaData">
            <xsl:call-template name="printMetaDate.mods.relatedItem">
              ...
              <xsl:with-param name="label" select="mcri18n:translate('component.mods.metaData.dictionary.articleIn')" />
            </xsl:call-template>
            <xsl:call-template name="printMetaDate.mods">
              <xsl:with-param name="nodes" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:subject" />
              <xsl:with-param name="sep" select="'; '" />
            ...
            <xsl:call-template name="printMetaDate.mods">
              <xsl:with-param name="nodes"
                select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:relatedItem[@type='isReferencedBy']/mods:titleInfo/mods:title" />
              <xsl:with-param name="label" select="mcri18n:translate('component.mods.metaData.dictionary.2ndSource')" />
            </xsl:call-template>
            <xsl:apply-templates mode="present" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:location/mods:url" />
            <xsl:apply-templates mode="present" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:accessCondition" />
            <xsl:apply-templates mode="present" select="./metadata/def.modsContainer/modsContainer/mods:mods/mods:name[@ID]" />
  ...
  <xsl:template match="/mycoreobject[contains(@ID,'_mods_')]" mode="present.av">
    <div id="title_box" class="detailbox floatbox">
      <h4 id="title_switch" class="block_switch open">
        <xsl:value-of select="mcri18n:translate('component.mods.metaData.dictionary.av')" />
      </h4>
      <xsl:call-template name="printMetaDate.mods.titleContent" />
    </div>
