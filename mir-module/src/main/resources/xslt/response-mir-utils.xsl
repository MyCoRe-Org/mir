...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template name="browse.Pagination">
    ...
    <xsl:variable name="label.previousHit"
      select="mcri18n:translate-with-params(concat($i18nprefix, '.previous'), $page - 1)" />
    <xsl:variable name="label.nextHit"
      select="mcri18n:translate-with-params(concat($i18nprefix, '.next'), $page + 1)" />
  ...
  <xsl:template name="resultList.Pagination">
    ...
    <xsl:variable name="label.firstPage" select="mcri18n:translate-with-params(concat($i18nprefix, '.first'), 1)" />
    <xsl:variable name="label.lastPage" select="mcri18n:translate-with-params(concat($i18nprefix, '.last'), $pages)" />
    <xsl:variable name="label.previousPage"
      select="mcri18n:translate-with-params(concat($i18nprefix, '.previous'), $page - 1)" />
    <xsl:variable name="label.nextPage"
      select="mcri18n:translate-with-params(concat($i18nprefix, '.next'), $page + 1)" />
