...
<xsl:stylesheet version="1.0"
  ...
  <!-- ws 1.2 -->
  <xsl:include href="../xsl/inc/dcmiType.xsl" />
  <xsl:include href="../xsl/inc/mimeType.xsl" />
  <xsl:include href="../xsl/inc/csdgm.xsl" />
  <xsl:include href="../xsl/inc/forms.xsl" />
  <xsl:include href="../xsl/inc/iso3166-1.xsl" />
  <xsl:include href="../xsl/inc/iso639-2.xsl" />
  ...
  <xsl:template match="dc:format">
    <physicalDescription>
      <xsl:choose>
        ...
        <xsl:when
          test="starts-with(.,'1') or starts-with(.,'2') or starts-with(.,'3') or starts-with(.,'4') or starts-with(.,'5') or starts-with(.,'6') or starts-with(.,'7') or starts-with(.,'8') or starts-with(.,'9')">
          <extent>
            <xsl:apply-templates />
          </extent>
        </xsl:when>
