...
<!--
    Vendored from Library of Congress, original formatting.
    https://www.loc.gov/standards/mods/v3/DC_MODS3-8_XSLT2-0.xsl
    Includes vendored locally from https://www.loc.gov/standards/mods/inc/
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    version="2.0">
    <!--
        Version 2.4     2023-05-16 ws
                        Upgraded to MODS 3.8
                        
        Version 2.3     2020-06-01 ws
                        Upgraded to MODS 3.7
                        
        Version 2.2     2020-06-01 ws
    ...
    <!-- ws 2.1 -->
    <xsl:include href="resource:xslt/inc/loc-dcmiType.xsl" />
    <xsl:include href="resource:xslt/inc/loc-mimeType.xsl" />
    <xsl:include href="resource:xslt/inc/loc-csdgm.xsl" />
    <xsl:include href="resource:xslt/inc/loc-forms.xsl" />
    <xsl:include href="resource:xslt/inc/loc-iso3166-1.xsl" />
    <xsl:include href="resource:xslt/inc/loc-iso639-2.xsl" />
    ...
    <xsl:template match="/">
        ...
        <!-- START MIR addition -->
        <xsl:if test="dc">
            <mods xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-8.xsd">
              <xsl:apply-templates />
            </mods>
        </xsl:if>
        <!-- END MIR addition -->
    ...
    <xsl:template match="sru_dc:dc">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
			    <mods version="3.8" xmlns="http://www.loc.gov/mods/v3" 
			        xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
			        xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-8.xsd">
					<xsl:call-template name="dcMain"/>
				</mods>
            ...
            <xsl:otherwise>
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="string(text()) = 'Service' or string(text()) = 'service'">
                        ...
                        <genre authority="dct">
                            <!-- WS: changed service to online system or service, re: mappings 2012-08-09 -->
