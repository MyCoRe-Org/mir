...
<xsl:stylesheet version="3.0"
  ...
  <xsl:import href="xslImport:metadatabox:metadata/metadata-box/mods/physical-description.xsl" />
  ...
  <xsl:template mode="display-metadata" match="mycoreobject">
    ...
    <xsl:for-each select="metadata/def.modsContainer/modsContainer/mods:mods/mods:physicalDescription/mods:extent">
