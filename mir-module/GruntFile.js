    ...
    uglify: {
      mir: {
        ...
        files: {
          ...
          '<%= globalConfig.moduleDirectory %>/target/classes/META-INF/resources/js/mir/accesskey.min.js': '<%= globalConfig.moduleDirectory %>/src/main/resources/META-INF/resources/js/mir/accesskey.js',
