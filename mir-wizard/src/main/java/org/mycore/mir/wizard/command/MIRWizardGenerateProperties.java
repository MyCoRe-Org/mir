...
public class MIRWizardGenerateProperties extends MIRWizardCommand {
    ...
    public void doExecute() {
        ...
        try {
            ...
            mcrProps.store(new FileOutputStream(file), "Generated by MIR Wizard.");
